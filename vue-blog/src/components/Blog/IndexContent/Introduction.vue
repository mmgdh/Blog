<template>
  <div class="card">
    ...
    <div class="buttons">
      <button id="follow"><a href="https://b23.tv/tURaixv">＋关注</a></button>
      <button id="message">私信</button>
    </div>
  </div>
</template>
...
body {
  background: rgb(241, 169, 91);
  background: linear-gradient(45deg, rgba(241, 169, 91, 1) 27%, rgba(180, 86, 235, 1) 100%);
  height: 100vh;
  display: flex;
  align-items: center;
